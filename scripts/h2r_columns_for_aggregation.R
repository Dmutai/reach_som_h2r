...
select_multile_col_fs <-c("education_available.none", "available_health_services.mobile_clinic",
                       "available_health_services.hospital","available_health_services.clinic", 
                       "conflict_causes.none","protection_incidents.none","conflict_causes.water_dispute",
                       "info_mainsource.radio" 
)
...
yes_no_colmns_fs <- c("still_contact_htr","access_healthservices","surfacewater_drinking","particip_again"  )
...
# 
# factsheet_columns <-c("education_available.none", "access_market",  "distance_to_market",
#                       "food_situation", "access_healthservices",  "available_health_services.mobile_clinic",
#                       "available_health_services.hospital","available_health_services.clinic", "conflict_causes.none", "protection_incidents.none", 
#                       "surfacewater_drinking","conflict_causes.water_dispute","info_mainsource.radio"
# )
...
equal_fs <- c("base",
           ...
           "info_settlement_other", "info_set_oth_near", "label_settlement",
           "when_left_prev",
           "access_market" ,"distance_to_market", "food_situation" 
