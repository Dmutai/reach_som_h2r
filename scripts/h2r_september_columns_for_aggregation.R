...
select_multile_col <-c("available_health_services.none", "available_health_services.mobile_clinic",
  ...
  "sources_covid_informaiton.healthcare_workers", "sources_covid_informaiton.don.t_know" ,"sources_covid_informaiton.mobile_operator", "covid_measures.no_measure_taken", 
  ...
  "covid_measures.keeping_people", "caretaker_who.community_neighbors", "caretaker_who.kafala", "caretaker_who.formal_orphanage",
  "caretaker_who.unaccompanied", "caretaker_who.don.t_know", "caretaker_who_other","uac_where_live.house", "uac_where_live.street", 
  "uac_where_live.workplace", "uac_where_live.other_specify", "uac_where_live.don.t_know", "child_services.none", 
  "child_services.family_tracing", "child_services.socialworkers", 
  "child_services.referral_services", "child_services.psychosocial_support", 
  "child_services.other_specify", "child_services.don.t_know", 
  "child_services.alternative_care", "women_unsafeplaces.none", 
  "women_unsafeplaces.checkpoints", "women_unsafeplaces.waterpoints", 
  "women_unsafeplaces.field", "women_unsafeplaces.other", "women_unsafeplaces.latrines", 
  "women_unsafeplaces.roads", "women_unsafeplaces.markets", "women_unsafeplaces.noresponse", 
  "women_unsafeplaces.dontknow", "women_protincid.none", "women_protincid.marriage_underaged", 
  "women_protincid.physical_violence", "women_protincid.killing", 
  "women_protincid.other", "women_protincid.sexual_violence", "women_protincid.dontknow", 
  "women_protincid.noresponse","women_services.none", "women_services.treatment_rape", "women_services.treatment_gbv", 
  "women_services.psychosocial_support", "women_services.other", 
  "women_services.legal_support", "women_services.shelters_for_victims", 
  "women_services.noresponse", "women_services.dontknow"
